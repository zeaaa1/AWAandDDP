...
def args_parser():
    ...
    parser.add_argument('--federated_learning', default=True,
                        help="centralized or federated learning")  # True: FL
    ...
    parser.add_argument('--model', type=str, default='lstm',
                        choices=['cnn2', 'cnn3', 'mlp', 'linear', 'lstm'],
    ...
    parser.add_argument('--quantization', default=False,
    ...
    parser.add_argument('--seed', type=float, default=125,
